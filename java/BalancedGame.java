...
Version 2.8 - The Mild(ish) Update
*/
import java.util.*;
import java.io.*;
    ...
    public static void dustMenu(int i) throws IOException {
        ...
        if (choice==1) {
            ...
            if (weaponType>=1 && weaponType<=5) {
                ...
                arr[i].getWeapon(weaponType-6).addDmgs(elementNum, amount*tierDamage[tier-1]);
